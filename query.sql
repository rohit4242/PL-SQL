...
-- end;
-- /
--  start F:\Rohit\PL-SQL-4\query.sql

create or replace procedure hello_msg(name in varchar2,nm in varchar2)
is

begin
    dbms_output.put_line('Hello '||name||'!'|| nm);
    

    end;
/
exec hello_msg('Rohit',45);
